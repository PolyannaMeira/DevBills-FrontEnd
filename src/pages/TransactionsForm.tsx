...
import type { TRANSACTION_TYPE, CreateTransactionDTO } from "../types/transaction";
...
const TransactionsForm = () => {
  ...
  const handleSubmit = async (event: React.FormEvent): Promise<void> => {
    ...
    const normalized = formData.amount.replace(/\./g, "").replace(",", ".").trim();
    const amountNumber = Number(normalized);
  ...
  const handleTransactionType = (itemType: typeof TRANSACTION_TYPE[keyof typeof TRANSACTION_TYPE]): void => {
